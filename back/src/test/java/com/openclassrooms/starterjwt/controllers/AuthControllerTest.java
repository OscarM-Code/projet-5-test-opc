...
class AuthControllerTest {
    ...
    public void testAuthenticateUserOk() {
        ...
        assertEquals(email,
                responseBody != null && responseBody.getUsername() != null ? responseBody.getUsername() : null);
        assertEquals(firstname,
                responseBody != null && responseBody.getFirstName() != null ? responseBody.getFirstName() : null);
        assertEquals(lastname,
                responseBody != null && responseBody.getLastName() != null ? responseBody.getLastName() : null);
        assertEquals(id, responseBody != null && responseBody.getId() != null ? responseBody.getId() : null);
        assertEquals(isAdmin, responseBody != null && responseBody.getAdmin() != null ? responseBody.getAdmin() : null);
        assertEquals("Bearer", responseBody != null && responseBody.getType() != null ? responseBody.getType() : null);
    ...
    public void testRegisterUserEmailAlreadyTaken() {
        ...
        assertEquals("Error: Email is already taken!",
                messageResponse != null && messageResponse.getMessage() != null ? messageResponse.getMessage() : null);
